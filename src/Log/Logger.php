...
class Logger implements LoggerInterface {
	 ...
	 * Logger constructor.
	 *
	 * @param   AbstractProcessingHandler  $handler  The Monolog handler
	 * @param   string                     $name     The name of your logger
	 */
	public function __construct( AbstractProcessingHandler $handler, string $name = 'square-one' ) {
