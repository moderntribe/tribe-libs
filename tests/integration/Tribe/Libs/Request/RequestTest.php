...
class RequestTest extends \Codeception\TestCase\WPTestCase {
	...
	public function testHeaders() {
		...
		$server_mock = $this->makeEmpty( Server::class, [ 'get_headers' => function () use ( $expected ) {
			return $expected;
		} ] );
		$request     = new Request( $server_mock );
	...
	public function testHeader() {
		...
		$server_mock = $this->makeEmpty( Server::class, [ 'get_headers' => function () use ( $headers ) {
			return $headers;
		} ] );
		$request     = new Request( $server_mock );
	...
	public function testInput() {
		...
		$server_mock    = $this->makeEmpty( Server::class, [ 'get_input' => function () use ( $input ) {
			return $input;
		} ] );
		$request        = new Request( $server_mock );
	...
	public function testAll() {
		...
		$server_mock      = $this->makeEmpty( Server::class, [
		...
		$server_mock_post = $this->makeEmpty( Server::class, [
			'get_method'       => function () use ( $input ) {
				return 'POST';
			},
			'get_input'        => function () use ( $input ) {
		...
		$request          = new Request( $server_mock );
		$request_post     = new Request( $server_mock_post );
	...
	public function testOnly() {
		...
		$server_mock = $this->makeEmptyExcept( Server::class, 'input', [
			'get_method' => function () {
				return 'GET';
			},
			'get_input'  => function () use ( $input ) {
	...
	public function testPath() {
		...
		$server_mock            = $this->makeEmptyExcept( Server::class, 'get_path' );
		$request                = new Request( $server_mock );
	...
	public function testUrl() {
		...
		$server_mock = $this->makeEmptyExcept( Server::class, 'get_url' );
		$request     = new Request( $server_mock );
	...
	public function testFullURL() {
		...
		$server_mock = $this->make( Server::class );
		$request     = new Request( $server_mock );
	...
	public function testIs() {
		$_SERVER['REQUEST_URI'] = '/test_page?foo=bar&bash=baz';
		$path                   = 'test_page';
		$server_mock_simple     = $this->makeEmptyExcept( Server::class, 'get_path' );
		$request_simple         = new Request( $server_mock_simple );
